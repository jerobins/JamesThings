 ...
 *
    ...
    1.5 2017-10-27
         -updated color scheme, changed namespace to add to my github repo
...
metadata {
	...
	definition (name: "aeonSwitch", namespace: "jerobins", author: "mike maxwell") {
		capability "Actuator"
		capability "Switch"
		capability "Refresh"
		capability "Sensor"
	...
	tiles {
		standardTile("switch", "device.switch", width: 2, height: 2, canChangeIcon: true, canChangeBackground: true) {
			state "on", label:'${name}', action:"switch.off", backgroundColor:"#00A0DC"
